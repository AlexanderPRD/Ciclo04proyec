...
declare const Proyectoloopback4ApApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class Proyectoloopback4ApApplication extends Proyectoloopback4ApApplication_base {
